...
describe('cohort class', () => {
  ...
  describe('#enroll', () => {
    const student = new Student('Sam Seaborn', 'sam.seaborn@gmail.com');
  ...
  describe('#assign', () => {
    it('adds a system check to the students array', () => {
  ...
  describe('#roster', () => {
    beforeEach(() => {
      studentOne = new Student('Mandy Hampton', 'mandy.hampton@gmail.com');
      studentTwo = new Student('Josh Lyman', 'josh.lyman@gmail.com');
      studentThird = new Student('Leo McGarry', 'leo.mcgarry@gmail.com');
    ...
    it("returns a roster message that is a string containing the cohort's title", () => {
      expect(cohort.roster()).toContain('Cohort 30');
    });

    it('returns a roster message that is a string containing each students name and email seperated by a new line', () => {
      expect(cohort.roster()).toContain('Mandy Hampton mandy.hampton@gmail.com\n');
